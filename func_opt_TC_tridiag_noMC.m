function [B, Theta, Obj] = func_opt_TC_tridiag_noMC(sRT_hat, sRI_hat, sIT_hat)

NI = size(sIT_hat,1);
Y0 = 1/50;

% Vectors alpha and beta
a = 1i * (sIT_hat + exp(1i * angle(sRT_hat)) * sRI_hat');
b = Y0 * (sIT_hat - exp(1i * angle(sRT_hat)) * sRI_hat');
