...
The file `main_gen_ZIIs.m` generates `ZIIs-d-lambda-i.mat`, for *i* = 1, ..., 4, containing the mutual coupling matrices when the ratio between inter-element distance and wavelength is *i*.
